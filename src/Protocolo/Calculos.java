...
public class Calculos {
    ...
    public void Inicializa(String rgprp, String rgimv, String contrato) throws SQLException {
        ...
        this.rComissao = LerValor.StringToFloat(LerValor.FormatNumber(conn.LerParametros("comisvr"), 2));
        ...
        if (rgprp.equals("") && rgimv.equals("") && contrato.equals("")) {
            ...
            if (conn.LerCamposTabela(new String[] {"RGIMV"}, "MULTA", "RGIMV = '" + this.rgimv + "'") != null) {
                ...
                regFields = conn.LerCamposTabela(new String[] {"te_per", "te_vrm", "txexp", "tbrliq", "multa_res", "multa_com", "dia_mul", "dia_jur", "per_jur", "cor_tipo", "cor_lim_a", "cor_corr", "dia_cor", "comissao", "comisvr"}, "MULTA", "RGIMV = '" + this.rgimv + "'");
                ...
                this.rComissao = LerValor.StringToFloat(LerValor.FormatNumber(regFields[14][3], 2));
           } else {
            if (conn.LerCamposTabela(new String[] {"RGPRP"}, "MULTA", "RGPRP = '" + this.rgprp + "' AND IsNull(RGIMV)") != null) {
                String[][] regFields = null;
                regFields = conn.LerCamposTabela(new String[] {"te_per", "te_vrm", "txexp", "tbrliq", "multa_res", "multa_com", "dia_mul", "dia_jur", "per_jur", "cor_tipo", "cor_lim_a", "cor_corr", "dia_cor", "comissao", "comisvr"}, "MULTA", "RGPRP = '" + this.rgprp + "' AND IsNull(RGIMV)");
                this.taxa_per = LerValor.StringToFloat(LerValor.FormatNumber(regFields[0][3], 3));
                this.taxa_vrm = LerValor.StringToFloat(LerValor.FormatNumber(regFields[1][3], 2));
                this.taxa_exp = regFields[2][3];
                //'this.taxa_brlq = regFields[3][3]
    ...
    public float[] percComissao(String rgprp, String rgimv) throws SQLException {
        ...
        if (conn.LerCamposTabela(new String[] {"RGIMV"}, "MULTA", "RGIMV = '" + rgimv + "'") != null) {
            ...
            rComissao = Float.valueOf(LerValor.FormatNumber(regFields[1][3], 2).replace(",", "."));
        } else {
