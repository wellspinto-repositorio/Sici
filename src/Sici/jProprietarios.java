...
//        }
    ...
    private void GravarDados() throws SQLException {
        ...
        try {pResult.updateString("repdtnasc", Dates.DateFormata("yyyy-MM-dd",mDtNascRep.getDate()));} catch (Exception ex) {}
        ...
        try {pResult.updateString("dtnasc", Dates.DateFormata("yyyy-MM-dd",mDtNasc.getDate()));} catch (Exception ex) {}
        ...
        try {pResult.updateString("conjdtnasc", Dates.DateFormata("yyyy-MM-dd",mDtNascConj.getDate()));} catch (Exception ex) {}
        ...
        try {pResult.updateString("dtcadastro", Dates.DateFormata("yyyy-MM-dd",mDtEntrada.getDate()));} catch (Exception ex) {}
        pResult.updateString("status", mStatus.getSelectedItem().toString());
        try {pResult.updateString("dtsaida", Dates.DateFormata("yyyy-MM-dd",mDtSaida.getDate()));} catch (Exception ex) {}
