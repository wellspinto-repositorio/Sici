        ...
        for (int i=0;i<=selRow.length - 1;i++) {
            ...
            try {
                ...
                if(jchbPreview.isSelected()) {
                    ...
                    String[][] asend = this.conn.LerCamposTabela(new String[]{"envio"}, "locatarios", "contrato = '" + contrato + "'");
                    if(asend != null) {
                        if(Integer.valueOf(asend[0][3]).intValue() == 1) {
                            String msg = (new JEmail()).SendEmail(contrato, new String[]{outFileName}, "Boleta de Aluguel", "Prezado(a),\nSegue em anexo boleto no formato pdf.\nFavor confirmar o recebimento.\n\nErica Santos Imóveis\nTel:(21) 2635-3390");
                            this.StatusEmail(outFileName, msg);
                        } else {
...
//            VariaveisGlobais.ccampos = pResult.getString("campo");
    ...
    private Boleta CreateBoleta(String rgprp, String rgimv, String contrato, String vencto, boolean reimp, String rnnumero, String dataBol) throws SQLException {
        ...
        String banco = "";
        //(bancos.getBanco().equalsIgnoreCase("104") ? "cef" : (bancos.getBanco().equalsIgnoreCase("341") ? "itau" : (bancos.getBanco().equalsIgnoreCase("003") ? "santander" : "bb")));
        ...
        //bean1.setbolDadosAgcodced(bancos.getAgencia() + "-" + bancos.CalcDig11(bancos.getAgencia(),9,2) + " / " + bancos.getConta() + bancos.CalcDig11(bancos.getConta(),9,2));
        if (banco.toLowerCase().equalsIgnoreCase("itau")) {
