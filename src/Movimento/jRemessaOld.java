 ...
 * @author supervisor
 */
public class jRemessaOld extends javax.swing.JInternalFrame {
    ...
    private void FillCombos() {
        //String sSql = "SELECT DISTINCT r.contrato AS codigo, Upper(l.nomerazao) AS nome, r.nnumero FROM RECIBO r, locatarios l WHERE (r.contrato = l.contrato) AND r.tag != 'X' AND r.nnumero != '' ORDER BY Upper(l.nomerazao);";
                      //"SELECT contrato as codigo, UPPER(nomerazao) as nome FROM locatarios WHERE fiador1uf <> 'X' OR IsNull(fiador1uf) ORDER BY UPPER(nomerazao);";
        String sSql = "SELECT contrato AS codigo, Upper(nome) AS nome, nnumero FROM bloquetos WHERE remessa = '" + (jbtEnvios.isSelected() ? "S" : "N") + "' AND rgprp != '' AND rgimv != '' AND contrato != '' GROUP BY contrato;";
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        ...
        for (int i=0; i<atable.getRowCount();i++) {
            if (filler.Open()) {
                ...
                String numCoC = "013000516"; // Conta Corrente 013000516
                String digCoC = "0"; // digito verificador
                String contCb = "013000516"; // Conta cobranca 7926383
                String digtCb = "0"; // digito
                String rservo = FuncoesGlobais.Space(2);
                String nnumer = FuncoesGlobais.StrZero(bean1.getbolDadosNnumero().substring(3).trim(),13); // nosso numero com 13 dig
                ...
                String numDoc = new Pad(_contrato,15).RPad(); //new Pad(bean1.getbolDadosNumdoc(),15).RPad(); // "000000000000000"; // numero do documento (livre)
                ...
                if (jtparq.getSelectedItem().toString().trim().substring(0, 2).equalsIgnoreCase("01")) {
                    /*
                    Marca remessa = 'S' 
                    */
                    String wSql = "UPDATE bloquetos SET remessa = 'S' WHERE nnumero LIKE '%" + bean1.getbolDadosNnumero().substring(3,bean1.getbolDadosNnumero().length() - 1) + "%';";
                    try {
                        conn.ExecutarComando(wSql);
                    } catch (Exception e) {}
                    ...
                    */
                    ...
                    String[] msg = {                
                        (!(bean1.getlocaDescL01() == null) ? new Pad(bean1.getlocaDescL01(),20).RPad() + " " + new Pad(bean1.getlocaCpL01(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL01(),15).LPad() : null),                
                        (!(bean1.getlocaDescL02() == null) ? new Pad(bean1.getlocaDescL02(),20).RPad() + " " + new Pad(bean1.getlocaCpL02(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL02(),15).LPad() : null),                
                        (!(bean1.getlocaDescL03() == null) ? new Pad(bean1.getlocaDescL03(),20).RPad() + " " + new Pad(bean1.getlocaCpL03(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL03(),15).LPad() : null),                
                        (!(bean1.getlocaDescL04() == null) ? new Pad(bean1.getlocaDescL04(),20).RPad() + " " + new Pad(bean1.getlocaCpL04(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL04(),15).LPad() : null),                
                        (!(bean1.getlocaDescL05() == null) ? new Pad(bean1.getlocaDescL05(),20).RPad() + " " + new Pad(bean1.getlocaCpL05(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL05(),15).LPad() : null),                
                        (!(bean1.getlocaDescL06() == null) ? new Pad(bean1.getlocaDescL06(),20).RPad() + " " + new Pad(bean1.getlocaCpL06(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL06(),15).LPad() : null),                
                        (!(bean1.getlocaDescL07() == null) ? new Pad(bean1.getlocaDescL07(),20).RPad() + " " + new Pad(bean1.getlocaCpL07(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL07(),15).LPad() : null),                
                        (!(bean1.getlocaDescL08() == null) ? new Pad(bean1.getlocaDescL08(),20).RPad() + " " + new Pad(bean1.getlocaCpL08(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL08(),15).LPad() : null),                
                        (!(bean1.getlocaDescL09() == null) ? new Pad(bean1.getlocaDescL09(),20).RPad() + " " + new Pad(bean1.getlocaCpL09(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL09(),15).LPad() : null),                
                        (!(bean1.getlocaDescL10() == null) ? new Pad(bean1.getlocaDescL10(),20).RPad() + " " + new Pad(bean1.getlocaCpL10(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL10(),15).LPad() : null),                
                        (!(bean1.getlocaDescL11() == null) ? new Pad(bean1.getlocaDescL11(),20).RPad() + " " + new Pad(bean1.getlocaCpL11(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL11(),15).LPad() : null),                
                        (!(bean1.getlocaDescL12() == null) ? new Pad(bean1.getlocaDescL12(),20).RPad() + " " + new Pad(bean1.getlocaCpL12(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL12(),15).LPad() : null),                
                        //(!(bean1.getlocaDescL13() == null) ? new Pad(bean1.getlocaDescL13(),20).RPad() + " " + new Pad(bean1.getlocaCpL13(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL13(),15).LPad() : null),                
                        //(!(bean1.getlocaDescL14() == null) ? new Pad(bean1.getlocaDescL14(),20).RPad() + " " + new Pad(bean1.getlocaCpL14(),10).RPad() + " R$" + new Pad(bean1.getlocaVrL14(),15).LPad() : null),                
        ...
        // Colocado aqui para testar 07-12-2016 12h41m
        //////////////////////////////////////////////////////////Santander.Remessa("remessa", "01", relacao);
