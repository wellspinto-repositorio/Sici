...
public class jVisitas extends javax.swing.JInternalFrame {
    ...
    public jVisitas() {
        ...
        comp.addFocusListener( new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ...
                if (dados != null) {
                    insert = false;
                    jNome.setText(dados[0][3]);
                    jDocto.setText(dados[1][3]);
                    jTelefone.setText(dados[2][3]);
                    try {jDataHora.setText(Dates.DateFormata("dd/MM/yyyy HH:mm", 
                            Dates.StringtoDate(dados[3][3],"yyyy/MM/dd HH:mm")));
 ...
 private void FillImoveisVazios() {
    ...
    private void SaveDados(String operacao) {
        ...
        try { conn.ExecutarComando(sql); } catch (Exception err) {}
    }   
